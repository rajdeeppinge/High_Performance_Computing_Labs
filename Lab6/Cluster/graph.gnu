...
set output "q1_problemSizeVsTime.png" 
set title 'Time vs problem size (Threads = 16)'
...
set output 'q1_problemSizeVsSpeedup.png'
...
set output 'q1_coresVsSpeedup.png'
...
set output 'q1_coresVsEfficiency.png'
